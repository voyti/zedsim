...
export class Positioning {
  ...
  getPointByDegreesInDistanceInReferenceToPointingUp(point, distance, degrees) {
  ...
  getWalkablePointAroundUnitInDistance(unit, distance, degrees) {
    ...
    const initialPoint = this.getPointByDegreesInDistanceInReferenceToPointingUp(unitPoint, distance, degrees);
