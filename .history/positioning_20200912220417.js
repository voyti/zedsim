...
export class Positioning {
  ...
  correctPointToNearestWalkable(point) {
    ...
    if (this.pathGrid.isWalkableAt(point.x, point.y)) {
      debugging.placeDebuggingMark(this.appBoard.stage, 'dest', 0x99ff99);
      return point;
    } else {
      debugging.placeDebuggingMark(this.appBoard.stage, 'Xdest', 0xff9999);
      ...
      if (xPossibility < yPossibility && xPossibility > 0) {
        debugging.placeDebuggingMark(this.appBoard.stage, 'Cdest(x)', 0x99ff99);
