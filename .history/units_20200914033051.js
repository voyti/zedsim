...
export class Units {
  ...
  getDirectionTowards(thisUnit, point) {
    ...
    return this.positioningService.calculateAngle(upwardsRef, thisUnit.sprite, point);
  }
  ...
  moveUnitTowardsAnother(unitToMove, targetUnit) {
    this.moveUnitInDirection(unitToMove, this.getDirectionTowards(unitToMove, targetUnit), ZOMBIE_ROAM_DISTANCE);
  }
