...
export class Positioning {
  ...
  init() {
    ...
    this.easystar.setGrid(_.times(boardConfig.width, () => {
      return _.times((boardConfig.height), () => 1);
    }));
  ...
  getPathFromSpriteTo(sprite, toPoint) {
    return this.finder.findPath(sprite.x, sprite.y, toPoint.x, toPoint.y, this.requestNewPathGrid());
  }
  ...
  correctPointToNearestWalkable(point) {
    ...
    if (this.pathGridPrototype.isWalkableAt(point.x, point.y)) {
